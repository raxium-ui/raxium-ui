...
import type { PopoverContentProps } from './props'
...
import { splitPopoverArrow } from './split-popover-arrow'
...
export const PopoverContent = forwardRef<HTMLDivElement, PopoverContentProps>(
  ({ className, theme: propsTheme, ui, children, ...props }, ref) => {
    ...
    const { arrows, rest } = useMemo(() => splitPopoverArrow(children), [children])
