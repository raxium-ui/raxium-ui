import type { loadImageAsyncOption } from './types/lazyload'
...
function style(el: HTMLElement, prop: 'overflow' | 'overflowY' | 'overflowX'): string {
  return typeof getComputedStyle !== 'undefined'
    ? getComputedStyle(el, null).getPropertyValue(prop)
    : el.style[prop]
}

function overflow(el: HTMLElement): string {
